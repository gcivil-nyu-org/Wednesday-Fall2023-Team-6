...
from hospital.models import Hospital, Hospital_Reviews
...
class AddReviewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.hospital = Hospital.objects.create(
            name='Test Hospital', location='Test Location', description='Test Description')
    ...
    def test_authenticated_user_can_add_review(self):
        ...
        response = self.client.post(self.url, {'Title': 'Test Review', 'rating': 4, 'Description': 'Test Description'})
